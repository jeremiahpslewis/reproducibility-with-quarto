...
CairoMakie.update_theme!(resolution=(parse(Float64, ENV["QUARTO_FIG_HEIGHT"])*100,
                                     parse(Float64, ENV["QUARTO_FIG_WIDTH"])*100
                                     ))
...
fig_height = parse(Float64, ENV["QUARTO_FIG_HEIGHT"])*100
fig_width = parse(Float64, ENV["QUARTO_FIG_WIDTH"])*100

if fig_format == "pdf"
  gr(size=(fig_width, fig_height), fmt = :pdf, dpi = 300)
end
